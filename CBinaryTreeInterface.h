...
// ============================================================================
// Header file for the class CBinaryTreeInterface.h
// ============================================================================
...
public:
   ...
   virtual void PreorderTraverse(void Visit(ItemType &item)) const = 0;
   virtual void InorderTraverse(void Visit(ItemType &item)) const = 0;
   virtual void PostorderTraverse(void Visit(ItemType &item)) const = 0;
